...
<body>
    ...
    <div class="lawFirm--page-title text-center lawFirm--bg-center" data-bg-img="assets/images/page-title-bg.png">
        <div class="container">
            <h2 class="pb-20">Lawyers Search Result</h2>
            <div class="title-bc"> <a href="#">Home</a> > <span> Layer Search Result </span></div>
        </div>
    </div>
    <!-- End of Page title -->
    ...
    <div class="container pt-120 pb-90">
        <div class="row">
            <div class="col-lg-10 col-md-12 offset-lg-1">
                <!-- Search Result Item -->
                <div class="lawFirm--search-result mb-50">
                    <div class="row align-items-lg-center align-items-top">
                        <div class="col-md-4">
                            <!-- Search Result Item Image -->
                            <div class="lawFirm--search-result-image">
                                <a href="#"><img src="assets/images/result-images/result-1.jpg" alt="" class="img-fluid" data-rjs="2"></a>
                            </div>
                            <!-- End of Search Result Item Image -->
                        </div>
                        <div class="col-md-8">
                            <!-- Search Result Item Text -->
                            <div class="lawFirm--search-result-text ul-default">
                                <!-- Search Result Info -->
                                <ul>
                                    <li class="d-flex"><span>Name</span> : <i>Andrea Anderson </i></li>
                                    <li class="d-flex"><span>Practice Area</span> : <i>Corporate Law </i></li>
                                    <li class="d-flex"><span>Phone</span> : <i>+390280634200 </i></li>
                                    <li class="d-flex"><span>Email</span> : <i>info@yahoomail.com </i></li>
                                    <li class="d-flex"><span>Office</span>: <i>Milan Piazzetta M. Bossi, 320121 Italy</i></li>
                                    <li class="d-flex"><span>Follow Me</span> : 
                                ...
                                <!-- End of Search Result Info -->

                                <!-- Read More Link -->
                                <a href="lawyer-details.php" class="btn"> See My Full Profile <img src="assets/images/rm-arrow.svg" alt="" class="img-fluid svg svg-btn"></a>
                                <!-- End of Read More Link -->

                            </div>
                            <!-- End of Search Result Item Text -->
                        </div>
                    </div>
                </div>
                ...
                <div class="lawFirm--search-result mb-50">
                    <div class="row align-items-lg-center align-items-top">
                        <div class="col-md-4">
                            <!-- Search Result Item Image -->
                            <div class="lawFirm--search-result-image">
                                <a href="#"><img src="assets/images/result-images/result-2.jpg" alt="" class="img-fluid" data-rjs="2"></a>
                            </div>
                            <!-- End of Search Result Item Image -->
                        </div>
                        <div class="col-md-8">
                            ...
                            <div class="lawFirm--search-result-text ul-default">
                                <!-- Search Result Info -->
                                <ul>
                                    <li class="d-flex"><span>Name</span> :<i>Aline Cardin</i> </li>
                                    <li class="d-flex"><span>Practice Area </span>:<i>Family Law</i></li>
                                    <li class="d-flex"><span>Phone</span> : <i>+390280634200</i> </li>
                                    <li class="d-flex"><span>Email</span> : <i>info@yahoomail.com</i></li>
                                    <li class="d-flex"><span>Office</span>: <i>Milan Piazzetta M. Bossi, 320121 Italy</i></li>
                                    <li class="d-flex"><span>Follow Me</span> :
                ...
                <div class="lawFirm--search-result mb-50">
                    <div class="row align-items-lg-center align-items-top">
                        <div class="col-md-4">
                            <!-- Search Result Item Image -->
                            <div class="lawFirm--search-result-image">
                                <a href="#"><img src="assets/images/result-images/result-3.jpg" alt="" class="img-fluid" data-rjs="2"></a>
                            </div>
                            <!-- End of Search Result Item Image -->
                        </div>
                        <div class="col-md-8">
                            ...
                            <div class="lawFirm--search-result-text ul-default">
                                <!-- Search Result Info -->
                                <ul>
                                    <li class="d-flex"><span>Name</span> : <i>Mike Taylor</i></li>
                                    <li class="d-flex"><span>Practice Area</span> : <i>Corporate Law</i></li>
                                    <li class="d-flex"><span>Phone</span> : <i>+390280634200</i></li>
                                    <li class="d-flex"><span>Email</span> : <i>info@yahoomail.com</i></li>
                                    <li class="d-flex"><span>Office</span>: <i>Milan Piazzetta M. Bossi, 320121 Italy</i> </li>
                ...
                <div class="lawFirm--search-result mb-50">
                    <div class="row align-items-lg-center align-items-top">
                        <div class="col-md-4">
                            <!-- Search Result Item Image -->
                            <div class="lawFirm--search-result-image">
                                <a href="#"><img src="assets/images/result-images/result-4.jpg" alt="" class="img-fluid" data-rjs="2"></a>
                            </div>
                            <!-- End of Search Result Item Image -->
                        </div>
                        <div class="col-md-8">
                            ...
                            <div class="lawFirm--search-result-text ul-default">
                                <!-- Search Result Info -->
                                <ul>
                                    <li class="d-flex"><span>Name</span> : <i>Adrian Cartwright</i></li>
                                    <li class="d-flex"><span>Practice Area</span> : <i>Business Law</i></li>
                                    <li class="d-flex"><span>Phone</span> : <i>+390280634200</i></li>
                                    <li class="d-flex"><span>Email</span> : <i>info@yahoomail.com</i></li>
                                    <li class="d-flex"><span>Office</span>:  <i>Milan Piazzetta M. Bossi, 320121 Italy</i></li>
                                    <li class="d-flex"><span>Follow Me</span> : 
                ...
                <!-- Pagination -->
                <div class="lawFirm--pagination ul-default">
                    <ul>
                        <li><a href="#" class="active">1</a></li>
                        <li><a href="#">2</a></li>
                        <li class="next-page"><a href="#"><img src="assets/images/p-next.svg" alt="" class="img-fluid svg   "></a></li>
                    </ul>
                </div>
                <!-- End of Pagination -->
            </div>
