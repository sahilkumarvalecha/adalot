...
<body>
    ...
    <div class="lawFirm--page-title text-center lawFirm--bg-center" data-bg-img="assets/images/page-title-bg.png">
        <div class="container">
            <h2 class="pb-20">Lawyers</h2>
            <div class="title-bc"> <a href="#">Home</a> > <span>Lawyers</span></div>
        </div>
    </div>
    <!-- End of Page title -->

    <!-- Team -->
    <div class="lawFirm--team pt-120 pb-70">
        <div class="container">
            <!-- Team Slider -->
            <div class="lawFirm--team-cover">
                <div class="row justify-content-sm-center">
                    <div class="col-lg-3 col-md-4 col-sm-6 lawFirm--nth">
                        <!-- Team Slider Item 01 -->
                        <div class="lawFirm--team-slider-item">
                            ...
                            <div class="lawFirm--team-slider-item-text text-center pt-25 pb-30">
                                <h4> <a href="lawyer-details.php">Andrea Anderson</a></h4>
                                <p>Corporate Law</p>
                            </div>
                            <!-- End of Item 01 Text -->
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 lawFirm--nth">
                        ...
                        <div class="lawFirm--team-slider-item">
                            ...
                            <!-- Item 02 Text-->
                            <div class="lawFirm--team-slider-item-text text-center pt-25 pb-30">
                                <h4> <a href="lawyer-details.php">James E. Hartley</a></h4>
                                <p>Insurance Law</p>
                            </div>
                            <!-- End of Item 02 Text -->
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 lawFirm--nth">
                        ...
                        <div class="lawFirm--team-slider-item">
                            ...
                            <!-- Item 03 Text-->
                            <div class="lawFirm--team-slider-item-text text-center pt-25 pb-30">
                                <h4> <a href="lawyer-details.php">Kyle Gray</a></h4>
                                <p>Environment Law</p>
                            </div>
                            <!-- End of Item 03 Text -->
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 lawFirm--nth">
                        ...
                        <div class="lawFirm--team-slider-item">
                            ...
                            <!-- Item 04 Text-->
                            <div class="lawFirm--team-slider-item-text text-center pt-25 pb-30">
                                <h4> <a href="lawyer-details.php">Laura S. Hundley</a></h4>
                                <p>Corporate Law</p>
                            </div>
                            <!-- End of Item 04 Text -->
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 lawFirm--nth">
                        ...
                        <div class="lawFirm--team-slider-item">
                            ...
                            <!-- Item 05 Text-->
                            <div class="lawFirm--team-slider-item-text text-center pt-25 pb-30">
                                <h4> <a href="lawyer-details.php">Adrian Cartwright</a></h4>
                                <p>Business Law</p>
                            </div>
                            <!-- End of Item 05 Text -->
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 lawFirm--nth">
                        ...
                        <div class="lawFirm--team-slider-item">
                            ...
                            <!-- Item 06 Text-->
                            <div class="lawFirm--team-slider-item-text text-center pt-25 pb-30">
                                <h4> <a href="lawyer-details.php">Mike Taylor</a></h4>
                                <p>Corporate Law</p>
                            </div>
                            <!-- End of Item 06 Text -->
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 lawFirm--nth">
                        ...
                        <div class="lawFirm--team-slider-item">
                            ...
                            <!-- Item 07 Text-->
                            <div class="lawFirm--team-slider-item-text text-center pt-25 pb-30">
                                <h4> <a href="lawyer-details.php">Robert Leeb</a></h4>
                                <p>Real State Law</p>
                            </div>
                            <!-- End of Item 07 Text -->
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 lawFirm--nth">
                        ...
                        <div class="lawFirm--team-slider-item">
                            ...
                            <!-- Item 08 Text-->
                            <div class="lawFirm--team-slider-item-text text-center pt-25 pb-30">
                                <h4> <a href="lawyer-details.php">Aline Cardin</a></h4>
                                <p>Family Law</p>
                            </div>
                            <!-- End of Item 08 Text -->
                        </div>
